...
Use `notion-axi` for Notion: search; read pages & databases; create, update (body + `--set` properties), and archive pages; read/add comments; `whoami`; or call any REST endpoint directly with `api`.
